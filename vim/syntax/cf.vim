" Vim syntax file
" Language: CFML, CFScript
" Maintainer: Toby Woodwark (toby.woodwark+vim@gmail.com)
" Last Change: 2011-09-14
" Filenames: *.cfc *.cfm
" Version: Adobe ColdFusion 9
" Usage: This file contains both syntax definitions and a list of known builtin
"        tags, functions and keywords.
"
" Refs - 
...
" TODO Not updated for ColdFusion 8/9.
" These are becoming a headache to maintain, so might be removed.
syn keyword cfArg contained abort accept access accessible accessors action addnewline addtoken
...
syn keyword cfFunctionName contained IsSpreadsheetObject FileSkipBytes Location ObjectLoad SerializeJSON SpreadsheetFormatColumn
...
" end of Deprecated tags and functions }}}
...
syn keyword cfScriptType        contained numeric boolean guid string any struct query void array
...
syn keyword cfScriptKeyword     contained function extends output hint accessors property getter setter nested
syn keyword cfScriptAccess      contained public private package
...
syn keyword cfScriptKeyword     contained query dbinfo

" function/component syntax
syn keyword cfScriptSpecial     contained required extends
syn keyword cfScriptOperator    contained = == != <= >= < > ++ --

syn cluster cfScriptCluster     contains=cfScriptOperator,cfScriptAccess,cfScriptType,cfScriptParen,cfScriptLineComment,cfScriptComment,cfScriptStringD,cfScriptStringS,cfScriptFunction,cfScriptNumber,cfScriptRegexpString,cfScriptBoolean,cfScriptBraces,cfHashRegion,cfFunctionName,cfDeprecatedFunction,cfScope,@cfOperatorCluster,cfScriptConditional,cfScriptRepeat,cfScriptBranch,@cfExpressionCluster,cfScriptStatement,cfScriptSpecial,cfScriptKeyword
...
syn region  cfcomponent         start="^\s*component" end="}" contains=@cfScriptCluster
syn region  cfscriptTag         contained start='<cfscript' end='>' keepend contains=cfTagName,htmlTag
" end of CFScript }}}

" CFML
syn cluster cfmlCluster contains=cfComment,@htmlTagNameCluster,@htmlPreproc,cfSetRegion,cfscriptBlock,cfOutputRegion,cfcomponent
